    ...
    <footer className="bg-background border-t py-8">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="space-y-4">
            <Link to="/" className="flex items-center space-x-2">
              ...
              <span className="font-bold text-lg">CoinQuest</span>
            </Link>
            <p className="text-sm text-muted-foreground">
              Earn coins by completing tasks and watching ads, then redeem for amazing rewards.
            </p>
          </div>
          ...
          <div>
            <h4 className="font-medium text-sm mb-4">Connect with Us</h4>
        ...
        <div className="mt-8 pt-6 border-t text-center text-sm text-muted-foreground">
          <p>&copy; {new Date().getFullYear()} CoinQuest Rewards. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
